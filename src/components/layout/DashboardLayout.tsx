...
import { Moon, Sun, Menu, LogOut, User, Settings as SettingsIcon } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className={cn('flex flex-col transition-all duration-300', sc ? 'lg:pl-20' : 'lg:pl-64')}>
        <header className="sticky top-0 z-20 flex h-16 items-center justify-between border-b border-border/70 bg-background/85 px-4 backdrop-blur-md lg:px-7">
          ...
          <div className="flex items-center gap-1.5">
            ...
            <div className="relative">
              ...
              <AnimatePresence>
                {um && <motion.div initial={{ opacity: 0, y: -8, scale: 0.98 }} animate={{ opacity: 1, y: 0, scale: 1 }} exit={{ opacity: 0, y: -8, scale: 0.98 }} transition={{ duration: 0.15 }} className="absolute right-0 top-12 w-52 overflow-hidden rounded-lg border border-border/70 bg-card shadow-luxury-lg">
